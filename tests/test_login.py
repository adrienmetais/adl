from context import login, account
...
class TestLogin(unittest.TestCase):
  ...
  def test_aes_crypt(self):
    ...
    cleartext = ""
    devicekey = "7Nc0TFtBePQ2VDSzPJMmWg=="
  
    crypted = login.aes_crypt(base64.b64decode(cleartext), base64.b64decode(devicekey))
  ...
  def test_generate_key(self):
    prvk, pubk = login.generate_key_pair()
    #print(prvk)
    #print(pubk)
